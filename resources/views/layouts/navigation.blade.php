        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin_calendars')" :active="request()->routeIs('admin_calendars')">
                        {{ __('Calendar') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin_h2h')" :active="request()->routeIs('admin_h2h')">
                        {{ __('Head 2 head') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin_clubs')" :active="request()->routeIs('admin_clubs')">
                        {{ __('Clubs') }}
                    </x-nav-link>
                </div>
            </div>
